  ...
  return (
    <div className='flex flex-col items-center justify-center gap-20 h-[100vh]'>
        ...
        <div className='flex justify-around items-center gap-13'>
            ...
            <div className=' mr-20'>
              <button className='btn btn-primary rounded-md px-3 py-1 text-2xl px-5 py-2'>Register</button>
              <button className='btn btn-warning mx-3 rounded-md px-3 py-1 text-2xl px-5 py-2'>Login</button>
            </div>
